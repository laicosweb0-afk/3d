...
| 6 | **Dove trovarci** | *ridisegno per azioni (brief Apple dell'utente, 04/08)*: l'invito «Vi aspettiamo al banco.» come titolo (non più congedo in fondo), due azioni GEMELLE a peso identico — venire / chiamare — la mappa ridotta a supporto (mezza altezza), e tre carte senza un solo filo: la strada (quattro momenti, spazio come gerarchia), l'aiuto (il numero protagonista in cifre d'aria, WhatsApp accanto, email sotto a peso minore), Seguici (una riga, non i cerchi da template) | dal numero-immagine all'invito: la sezione non mostra informazioni, guida alle azioni |
| 7 | **La firma** | *dal 05/08 (decisione utente)*: il medaglione d'avorio — il marchio vero nella ceramica, composto non generato — direttamente sul verde, col nome in maiuscoletto spaziato sotto; la targa di latte è caduta: la ceramica è dentro il medaglione, una carta dietro era una cornice intorno a una cornice | il centrato qui è guadagnato: è una firma |
