    ...
    <header className="sticky top-0 z-20 vetro" style={{ paddingTop: 'env(safe-area-inset-top)' }}>
      <div className="flex h-[52px] items-center justify-between px-6">
        <div className="flex items-center gap-2">
          ...
          {/* Il marchio basta da solo: «WO•MAN» è già il nome, e scriverlo
              due volte accanto a se stesso è il modo più rapido di far
              sembrare improvvisata una testata. */}
          <WomanLogo size={17} title="Woman Parfume Store" />
        </div>
