...
| 11 | ~~Profilo Instagram e indirizzo email~~ | **chiuso** — Instagram: @quellidellabufala (screenshot del profilo vero, 04/08). Email: quellidellabufala1@gmail.com (dettata dall'utente, 04/08) — è il canale che riceve gli ordini del compositore, per sua decisione («l'ordine facciamolo tramite email»; prima era WhatsApp). Tre glifi nei canali del colophon. Le frasi della bio Instagram NON entrano nel copy (claim non approvati); l'email obsoleta del biglietto resta bandita | — |
...
finestre di prenotazione a colonne, invio via email con oggetto e corpo
già scritti — decisione utente 04/08, prima era WhatsApp; porta
